...
# Our Architecture
# INPUT -> [CONV -> RELU -> POOL -> CONV -> RELU -> POOL] -> DROPOUT -> (FLATTEN) -> FC -> RELU -> FC -> SOFTMAX
...
save_path = os.path.join(save_directory,'SVHN_32x32_Grayscale_3d')
# saver.restore(sess=session,save_path=os.path.join(save_directory,'SVHN_32x32_Grayscale_3b'))
