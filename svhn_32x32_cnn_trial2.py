...
# Our Architecture
# INPUT -> [CONV -> RELU -> POOL -> CONV -> RELU -> POOL] -> DROPOUT -> (FLATTEN) -> FC -> RELU -> DROPOUT -> FC -> SOFTMAX
...
layer_flat,features_num = flatten_layer(dropout)
print("-------------------------------------------")
...
with tf.name_scope('DROPOUT'):
	dropout2 = tf.nn.dropout(fully_connected_l_1,dropout_keep_prob)
print("-------------------------------------------")
print("Output of Dropout")
print(dropout2)

fully_connected_l_2 = fully_connected_layer(input=dropout2,layer_name="Fully_Connected_2",inputs_num=fully_connected_layer_size,outputs_num=classes_num,use_relu=False)
print("-------------------------------------------")
...
save_path = os.path.join(save_directory,'SVHN_32x32_Grayscale_2b')
