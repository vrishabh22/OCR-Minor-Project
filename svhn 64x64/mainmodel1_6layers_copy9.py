...
save_path = os.path.join('checkpoints_6layers_copy9/', 'svhn_multi_v5_6layers')

try:
    print("Restoring last checkpoint ...")
    last_chk_path = tf.train.latest_checkpoint(checkpoint_dir='checkpoints_6layers_copy9')
    print(last_chk_path)
